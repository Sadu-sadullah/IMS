...
class CustomUser(AbstractUser):
    USER_TYPE = ((1, "HOD"), (2, "Staff"), (3, "Intern"))
...
class Intern(models.Model):
    admin = models.OneToOneField(CustomUser, on_delete=models.CASCADE)
    department = models.ForeignKey(Department, on_delete=models.DO_NOTHING, null=True, blank=False)
    shift = models.ForeignKey(Shift, on_delete=models.DO_NOTHING, null=True)
    staff = models.ForeignKey(Staff, on_delete=models.DO_NOTHING, null=True, blank=False)

    def __str__(self):
        return f"{self.admin.last_name}, {self.admin.first_name} ({self.department})"
...
class Attendance(models.Model):
    shift = models.ForeignKey(Shift, on_delete=models.DO_NOTHING, default = False)
    task = models.ForeignKey(Task, on_delete=models.DO_NOTHING, default=False)
...
class AttendanceReport(models.Model):
    intern = models.ForeignKey(Intern, on_delete=models.DO_NOTHING)
...
def create_user_profile(sender, instance, created, **kwargs):
    if created:
        ...
        if instance.user_type == 3:
            Intern.objects.create(admin=instance)
