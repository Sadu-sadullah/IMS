"""
Django settings for intern_management_system project.
...
ROOT_URLCONF = 'intern_management_system.urls'
...
WSGI_APPLICATION = 'intern_management_system.wsgi.application'
